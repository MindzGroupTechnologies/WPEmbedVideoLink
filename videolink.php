...
/**
 * Plugin Name: MGT Embed Video Link
...
add_shortcode('evl', 'evl_process_shortcode');
evl_register_styles();

function evl_process_shortcode( $attributes, $content = null ) {
    ...
    $vid_info = evl_getVideoInfo($video_url);    
	return 
        ...
        <div class="col-md-7 col-sm-7">
            <div class="row">
                ...
                <div class="col-md-12 vid_info">
                    duration: <strong>'.evl_parseDuration($vid_info->items[0]->contentDetails->duration).'</strong>
                </div>
...
function evl_parseDuration($duration) {
  $match = array();
